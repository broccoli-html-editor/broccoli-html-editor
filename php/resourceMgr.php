...
class resourceMgr{
	...
	// 	if( !fs.existsSync(path) || !fs.statSync(path).is_file() ){
	// 		return false;
	// 	}
	// 	return true;
	// }
	// function is_dir(path){
	// 	if( !fs.existsSync(path) || !fs.statSync(path).is_dir() ){
	// 		return false;
	// 	}
	// 	return true;
	// }
